...
const HotDessertssC = () => {
    ...
    const [allHotDessertss, setAllHotDessertss] = useState([]);
    ...
    const filter = () => {
        let filterHotDessertss;

        if (search) {
            if (from) {
                if (to) {
                    filterHotDessertss = allHotDessertss.filter(a => a.price >= from && a.price <= to && a.description.includes(search))
                }
                else {
                    filterHotDessertss = allHotDessertss.filter(a => a.price >= from && a.description.includes(search))
                }
            }
            else {
                if (to) {
                    filterHotDessertss = allHotDessertss.filter(a => a.price <= to && a.description.includes(search))
                }
                else {

                    filterHotDessertss = allHotDessertss.filter(a => a.description.includes(search))
                }
            }
        }
        else {
            if (from) {
                if (to) {
                    filterHotDessertss = allHotDessertss.filter(a => a.price >= from && a.price <= to)
                }
                else {
                    filterHotDessertss = allHotDessertss.filter(a => a.price >= from)
                }
            }
            else {
                if (to) {
                    filterHotDessertss = allHotDessertss.filter(a => a.price <= to)
                }
                else {

                    filterHotDessertss = allHotDessertss
                }
            }
        }
        setHotDessertss(filterHotDessertss)
    }
