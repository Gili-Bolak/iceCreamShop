...
const FrozensM = () => {
    ...
    const [updateFrozen, setUpdateFrozen] = useState(null)
    ...
    const handleDeleteClick = (frozen) => {
        Swal.fire({
            title: "Are you sure?",
    ...
    const handleUpdateClick = (frozen) => {
    ...
    const footerContentUpdate = (
        <div>
            <Button disabled={priceDisabledUpdate} label="עדכון" onClick={() => {
                ...
                handleUpdateClick(updateFrozen)
                setUpdateFrozen(null)
            }} autoFocus />
    ...
    const handleAddClick = () => {
        ...
        formData.append("category", "frozen")
                ...
                <div className={classNames('flex flex-column xl:flex-row xl:align-items-start p-4 gap-4', { 'border-top-1 surface-border': index !== 0 })}>
                    ...
                    <div className="flex flex-column sm:flex-row justify-content-between align-items-center xl:align-items-start flex-1 gap-4">
                        ...
                        <div className="flex sm:flex-column align-items-center sm:align-items-end gap-3 sm:gap-2">
                            ...
                            <Button onClick={() => { handleDeleteClick(frozen) }} icon="pi pi-trash" rounded outlined aria-label="Filter" />
    ...
    const header = () => {
        return (
            <div className="headerManager">
                <Button className="buttonAdd" label="הוספת פרוזן" onClick={() => {
                    setVisibleAdd(true);
                    setCodeAdd("");
                    setDescriptionAdd("");
                    setStockAdd("");
                ...
                <Dialog header="פרוזן" visible={visibleAdd} style={{ width: '50vw' }} onHide={() => setVisibleAdd(false)} footer={footerContentAdd}>
                    <p className="m-0">
                        <br />
                        <div className="dialogInput">
                            <span className="p-float-label">
